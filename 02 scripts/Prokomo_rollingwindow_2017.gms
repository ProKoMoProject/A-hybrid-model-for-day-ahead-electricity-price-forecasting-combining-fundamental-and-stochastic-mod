...
$setglobal result       Results_year%YearonFocus%_stoch
...
*#############################   DATA LOAD     ###############################
* if 01_declare_parameters is activated, the model runs deterministic
* if 01_declare_parameters_stoch.gms is activated, the model runs stochastic

*$include 01_declare_parameters.gms
$include 01_declare_parameters_stoch.gms
...
*#############################   MODEL     #####################################
* if 02_MODEL_stoch is activated, the model runs deterministic
* if 02_MODEL_stoch.gms is activated, the model runs stochastic


*$include 02_MODEL.gms
$include 02_MODEL_stoch.gms
